...
// php app/Services/PaymentService/CertificateDownloader.php -k ${83547cc6712145be61c1f447cb4752fe} -m ${1577963751} -f ${storage/wechat/apiclient_key.pem} -s ${766D55E9A5223A06DAD2758B4D72829DE4598219} -o ${storage/wechat/log.txt}
 /**
