...
EOF;
    ...
    function printComplexReceipt80()
    {
        ...
        $printContent = $printContent . "<C>" . "<B>***美食聚***</B>" . "<BR></C>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . "<C>" . "<B>#88810</B>" . "<BR></C>";
        $printContent = $printContent . "<C>下单时间：" . "2023-09-01 00:00:00"."<BR></C>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . "<C>*潮汕牛肉火锅 Ресторан Chaoshan*<BR></C>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . str_repeat("*", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
        $printContent = $printContent . "<B>顾客备注：" . "少放辣 不吃香菜" . "</B><BR>";
        $printContent = $printContent . str_repeat("*", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . "品名" . str_repeat(" ", NoteFormatter::MAX_HEAD_NAME_CHAR_LEN80 - 2) . "数量" . str_repeat(" ", 3) . "单价" . str_repeat(" ", 2)
            . "<BR>";
        $printContent = $printContent . "<le>Название товара" . str_repeat(" ", NoteFormatter::MAX_HEAD_NAME_CHAR_LEN80 - 13) . "Кол-во" . str_repeat(" ", 1) . "Цена<lc>" . str_repeat(" ", 2)
            . "<BR>";
        $printContent = $printContent . str_repeat("-", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("可乐鸡翅 баскет курица", 2, 9.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭Барселона Бургер с курицей Барселона Бургер с курицей", 1, 10108.11);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭Барселона Бургер с курицей Барселона Бургер с курицей", 1, 10099.12);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("炭烤鳕鱼炭烤鳕鱼炭烤鳕鱼 Барселона Бургер с курицей", 5, 19.99);
        ...
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("Барселона Бургер с курицей", 5, 19.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("巴塞罗那鸡肉汉堡(Барселона Бургер с курицей)", 5, 19.99);
        $printContent = $printContent . str_repeat("-", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
        $printContent = $printContent . "<R>" . "小计：" . "327.83" . "p" . "<BR></R>";
        $printContent = $printContent . "<R>" . "配送费：" . "327.83" . "p" . "<BR></R>";
        $printContent = $printContent . "<R>" . "税：" . "327.83" . "p" . "<BR></R>";
        $printContent = $printContent . "<R>" . "优惠：" . "327.83" . "p" . "<BR></R>";
        $printContent = $printContent . "<R><B>" . "实计：" . "327.83" . "p" . "</B><BR></BOLD></R>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . str_repeat("*", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
        $printContent = $printContent . "<BR>";
        $printContent = $printContent . "<L>"
            . "<B>配送地址：" . "珠海市香洲区xx路xx号" . "</B><BR>"
            . "<B>联系电话：" . "1363*****88" . "</B><BR>";

        $printContent = $printContent . "<C>"
            . "<QR>https://meishiju.ru</QR>"
            . "</C>";
